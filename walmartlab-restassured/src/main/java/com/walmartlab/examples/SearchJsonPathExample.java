package com.walmartlab.examples;
...
public class SearchJsonPathExample {
    ...
    @Test
    public void test004() {
        HashMap<String, Object> map = given().log().all()
                .queryParam("query", "ipod")
                .queryParam("apiKey", APIKEY)
                .queryParam("format", "json")
                .when()
        ...
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The gift options under the first product are: "+map);
        System.out.println("------------------End of Test---------------------------");
    }
    ...
    @Test
    public void test006() {
        List<String> names = given().log().all()
                .queryParam("query", "ipod")
                .queryParam("apiKey", APIKEY)
                .queryParam("format", "json")
                .when()
    ...
    public void test007() {
        ...
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The values for item name Apple iPod touch 32 GB are " + values);
        System.out.println("------------------End of Test---------------------------");
    }
